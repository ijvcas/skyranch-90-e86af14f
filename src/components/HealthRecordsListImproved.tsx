...
import { Edit, Trash2, Calendar, User, DollarSign, Pill, FileText } from 'lucide-react';
import { format } from 'date-fns';
import { es } from 'date-fns/locale';
import { useMutation, useQueryClient } from '@tanstack/react-query';
import { updateHealthRecord, deleteHealthRecord } from '@/services/healthRecordService';
        ...
        {records.map((record) => (
          <Card key={record.id} className="shadow-sm hover:shadow-md transition-shadow">
            <CardContent className="p-4">
              ...
              {record.description && (
                <p className="text-gray-700 mb-3 leading-relaxed">{record.description}</p>
              )}
