...
import { MapPin, Trash2, Info, Building, Leaf } from 'lucide-react';
...
const LotCard: React.FC<LotCardProps> = ({ lot, onSelect, onDelete, polygonData }) => {
  ...
  const getLotTypeInfo = (lotType?: string) => {
    if (lotType === 'property') {
      return {
  ...
  const lotTypeInfo = getLotTypeInfo(lot.lotType);
  ...
  return (
    <Card className="hover:shadow-md transition-shadow">
          ...
          <div className="flex-1">
            <CardTitle className="text-lg font-semibold flex items-center gap-2">
              ...
              <div className="flex gap-1">
                ...
                <Badge className={`text-xs flex items-center gap-1 ${lotTypeInfo.color}`}>
                  {lotTypeInfo.icon}
                  {lotTypeInfo.label}
                </Badge>
              </div>
      ...
      <CardContent className="space-y-3">
        ...
        {/* Grass Condition - only show for pasture lots */}
        {lot.lotType !== 'property' && (
        ...
        {/* Animal Count - only show for pasture lots */}
        {lot.lotType !== 'property' && lot.currentAnimals !== undefined && (
          <div className="flex items-center justify-between text-sm">
