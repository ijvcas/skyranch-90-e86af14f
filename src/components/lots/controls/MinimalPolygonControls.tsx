...
interface MinimalPolygonControlsProps {
  lots: Lot[];
...
const MinimalPolygonControls = ({
  ...
  onDeletePolygon,
  getLotColor
}: MinimalPolygonControlsProps) => {
  const [internalSelectedLotId, setInternalSelectedLotId] = useState<string>('');
...
export default MinimalPolygonControls;
