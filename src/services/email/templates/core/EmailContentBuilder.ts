...
export class EmailContentBuilder {
  ...
  static buildFooter(organizationName: string, currentYear: number): string {
    return `
      ...
      <div style="background: linear-gradient(135deg, #f0fdf4 0%, #ecfdf5 50%, #d1fae5 100%); padding: 40px 32px; border-top: 3px solid #10b981; text-align: center; position: relative;">
        ...
        <div style="position: relative; z-index: 1;">
          ...
          <div style="margin-bottom: 24px;">
            <h3 style="color: #10b981; margin: 0 0 16px 0; font-size: 18px; font-weight: 700; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', system-ui, sans-serif; letter-spacing: 0.5px;">
              Contacto Profesional
            </h3>
            <div style="display: inline-block; background: rgba(16, 185, 129, 0.08); padding: 16px 24px; border-radius: 12px; border: 1px solid rgba(16, 185, 129, 0.15);">
              <p style="color: #10b981; margin: 0 0 8px 0; font-size: 15px; font-weight: 600; font-family: 'Inter', sans-serif;">
                📧 soporte@skyranch.es
              </p>
              <p style="color: #34d399; margin: 0; font-size: 13px; font-weight: 500;">
          ...
          <div style="display: flex; align-items: center; justify-content: center; margin: 32px 0;">
            ...
            <div style="margin: 0 20px; padding: 8px 16px; background: linear-gradient(135deg, #10b981 0%, #34d399 100%); border-radius: 20px; box-shadow: 0 2px 8px rgba(16, 185, 129, 0.2);">
          ...
          <p style="color: #10b981; margin: 0 0 20px 0; font-size: 13px; line-height: 1.6; font-weight: 500; max-width: 500px; margin-left: auto; margin-right: auto;">
            Este es un mensaje automático del sistema <strong style="color: #10b981; font-weight: 700;">${organizationName}</strong>.<br>
            Por favor, no respondas a este correo electrónico.
          </p>
          
          <!-- Professional signature card -->
          <div style="background: linear-gradient(135deg, #ffffff 0%, #f8fafc 100%); border: 2px solid #d1fae5; border-radius: 16px; padding: 24px; margin: 24px auto 0; max-width: 400px; box-shadow: 0 4px 12px rgba(16, 185, 129, 0.08);">
            <div style="display: flex; align-items: center; justify-content: center; margin-bottom: 12px;">
              <div style="width: 32px; height: 32px; background: linear-gradient(135deg, #10b981 0%, #34d399 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 12px;">
                <span style="color: #ffffff; font-size: 16px; font-weight: bold;">🌿</span>
              </div>
              <p style="color: #10b981; margin: 0; font-size: 16px; font-weight: 700; font-family: 'Inter', sans-serif; letter-spacing: 0.5px;">
                Gestión Ganadera Profesional
              </p>
            </div>
            <p style="color: #34d399; margin: 0; font-size: 12px; font-weight: 500; letter-spacing: 0.3px;">
              Tecnología avanzada para el manejo eficiente de ganado
            </p>
          </div>
          
          <!-- Copyright with elegant styling -->
          <div style="margin-top: 32px; padding-top: 20px; border-top: 1px solid rgba(16, 185, 129, 0.15);">
